...
public final class Constants {
    ...
    public static final int TITLE_LENGTH_UPPER_BOUND = 25;

    public static final int COMMENT_LENGTH_LOWER_BOUND = 1;
    public static final int COMMENT_LENGTH_UPPER_BOUND = 500;
